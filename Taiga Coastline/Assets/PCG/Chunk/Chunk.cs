...
namespace PCG_Map.Chunk
{
    public class Chunk
    {
        ...
        private readonly Matrix2D _textures;
        private readonly Terrain _terrain;
        private readonly List<GameObject> _objects;


        public Chunk(GameObject chunk_obj, Vector2 position, Vector2Int size, int heights_map_resolution, Matrix2D heights, Matrix2D textures, Terrain terrain, List<GameObject> objects)
        {
        ...
        public Matrix2D Texture { get { return _textures; } }
