...
namespace PCG_Map.Chunk
{
    public class Chunk
    {
        ...
        public Chunk(GameObject chunk_obj, Vector2 position, Vector2Int size, int heights_map_resolution, NativeArray<float> heights, ChunkTexturesData textures, Terrain terrain, List<GameObject> objects)
        {
        ...
        public NativeArray<float> Heights { get { return _heights; } }
